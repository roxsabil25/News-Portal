...
const Footer = () => {
  return (
    <footer className="w-full bg-white text-gray-800 font-sans border-t border-gray-200">
      ...
      {/* Updated News Tip Link Button */}
      <div className="w-full bg-[#f7f5f0] border-b border-gray-200 py-3 px-4 flex justify-center items-center">
        <Link 
          to="/news-tips" 
          className="group inline-flex items-center justify-center gap-2 bg-white hover:bg-blue-50 text-blue-800 border border-blue-200 hover:border-blue-400 font-medium py-2.5 px-6 rounded-full shadow-sm hover:shadow transition-all duration-200 text-sm sm:text-base text-center"
        >
          <Send className="w-4 h-4 text-blue-700 group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-transform duration-200 shrink-0" />
          <span className="font-semibold">
            আমাদের কাছে একটি গল্প বা তথ্য পাঠান
          </span>
        </Link>
      </div>
          ...
          <div className="flex flex-col items-center md:items-end text-center md:text-right space-y-4">
            ...
            <div className="text-xs sm:text-sm text-gray-600 space-y-1.5 leading-relaxed">
              ...
              <div className="flex flex-wrap items-center justify-center md:justify-end gap-3 pt-1 text-gray-700 font-mono text-xs">
                ...
                <a href="tel:01533758487" className="flex items-center gap-1 hover:text-red-600 transition-colors">
