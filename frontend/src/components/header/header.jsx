...
const Header = () => {
  ...
  return (
    <header className="w-full bg-white border-b border-gray-200 font-sans sticky top-0 z-50 shadow-sm">
      ...
      <div className=" mx-auto px-2 sm:px-6 lg:px-6 bg-white text-white">
        <div className="flex items-center justify-between py-2  gap-2">
          ...
          <Link to="/" className="flex items-center space-x-2 sm:space-x-3 group shrink-0">
            <div className="w-12 h-16 sm:w-16 sm:h-20 overflow-hidden  shadow-sm group-hover:scale-105 transition-transform duration-200 rounded">
              <img src="/img/Capture-Photoroom.png" alt="আজাদ বাংলাদেশ" className="border-2 border-white  w-full h-full object-cover " />
            </div>
            <div className="flex flex-col">
              <span className="text-base sm:text-xl font-serif font-bold text-black leading-tight">
                আজাদির <span className="text-red-500">কথা</span>
              </span>
            </div>
          </Link>
          ...
          <div className="flex flex-col items-end text-[10px] sm:text-xs font-sans text-gray-700 shrink-0 leading-tight space-y-0.5">
            <span className="text-xs sm:text-sm font-bold text-black  pb-0.5 mb-0.5">
            ...
            <span className="text-red-500 font-semibold text-[10px] sm:text-[11px]">
              {formatHijriDate(currentTime)}
            </span>
            <span className="flex items-center gap-1 text-xs sm:text-xs font-mono font-bold text-black pt-0.5">
              <Clock className="text-red-500w-3 h-3 text-black shrink-0" />
